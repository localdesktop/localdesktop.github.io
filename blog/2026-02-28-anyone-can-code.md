...
```
   If you get `No command 'npm' found`, you may need to restart Termux after step 1.
...
- Make sure you enable ["All files access"](https://github.com/localdesktop/localdesktop/releases/tag/v1.4.7) for both Termux and Local Desktop so they can both read and write to the same location.
